...
func CORS(next http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		w.Header().Add("Access-Control-Allow-Origin", "todo-typescript-frontend.pages.dev")
		//w.Header().Add("Access-Control-Allow-Origin", "https://todo-typescript-frontend.pages.dev")
